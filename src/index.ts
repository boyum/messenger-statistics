...
function formatCounterObjects(object: { [key: string]: number }, showTotal: boolean = true): string {
...
function countWords(messages: FBMessage[], words: string[]): { [word: string]: number } {
...
function countMessagesFromParticipants(messages: FBMessage[], participants: FBParticipant[]): { [name: string]: number } {
...
function photoCount(messages: FBMessage[], participants: FBParticipant[]): { [name: string]: number } {
...
function videoCount(messages: FBMessage[], participants: FBParticipant[]): { [name: string]: number } {
...
function audioCount(messages: FBMessage[], participants: FBParticipant[]): { [name: string]: number } {
...
function countShouts(messages: FBMessage[], participants: FBParticipant[]): { [name: string]: number } {
